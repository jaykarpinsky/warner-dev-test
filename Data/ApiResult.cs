...
namespace WarnerTestJK.Data
{
    public class ApiResult<T>
    {
        ...
        /// <summary>
        /// Overload for CreateAsync
        /// </summary>
        /// <param name="source">An IQueryable source of generic type</param>
        public static async Task<ApiResult<T>> CreateAsync(IQueryable<T> source)
        {
            return await CreateAsync(source, 0, 9999, null, null, null, null);
        }
        ...
        public static async Task<ApiResult<T>> CreateAsync(IQueryable<T> source,
                                                            ...
                                                            string filterQuery = null)
        {
            return await CreateAsync(source, 0, 9999, null, null, filterColumn, filterQuery);
        }
